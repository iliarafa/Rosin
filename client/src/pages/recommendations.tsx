...
const content = {
  en: {
      ...
      presets: [
        {
          ...
          stages: [
            { num: "1", model: "claude-sonnet-4-5", reason: "Fast, capable baseline response" },
            { num: "2", model: "gemini-2.5-flash", reason: "Cross-provider verification" },
            { num: "3", model: "grok-3", reason: "Deep analysis and synthesis" },
            { num: "4", model: "claude-opus-4-5", reason: "Final independent check" },
          ],
        },
        {
          name: "SPEED OPTIMIZED",
          stages: [
            { num: "1", model: "gemini-2.5-flash", reason: "Fast initial response" },
            { num: "2", model: "claude-haiku-4-5", reason: "Quick cross-check" },
            { num: "3", model: "grok-3-fast", reason: "Rapid synthesis" },
          ],
        },
        {
          name: "MAXIMUM ACCURACY",
          stages: [
            { num: "1", model: "claude-opus-4-5", reason: "Thorough initial analysis" },
            { num: "2", model: "gemini-2.5-pro", reason: "Deep verification" },
            { num: "3", model: "grok-3", reason: "Comprehensive cross-check" },
            { num: "4", model: "claude-sonnet-4-5", reason: "Final synthesis" },
          ],
        },
      ],
    },
    ...
    stageRoles: {
      ...
      stages: [
        { stage: "Stage 1 (Initial)", role: "Generate baseline response", recommended: "claude-sonnet-4-5, gemini-2.5-flash" },
        { stage: "Stage 2 (Verify)", role: "Cross-check claims, flag errors", recommended: "gemini-2.5-flash, grok-3" },
        { stage: "Stage 3 (Analyze)", role: "Deep analysis, find discrepancies", recommended: "claude-opus-4-5, gemini-2.5-pro" },
        { stage: "Stage 4 (Synthesize)", role: "Distill final verified response", recommended: "grok-3, claude-sonnet-4-5" },
      ],
    },
  ...
  gr: {
      ...
      presets: [
        {
          ...
          stages: [
            { num: "1", model: "claude-sonnet-4-5", reason: "Γρήγορη, ικανή αρχική απάντηση" },
            { num: "2", model: "gemini-2.5-flash", reason: "Επαλήθευση από διαφορετικό πάροχο" },
            { num: "3", model: "grok-3", reason: "Βαθιά ανάλυση και σύνθεση" },
            { num: "4", model: "claude-opus-4-5", reason: "Τελικός ανεξάρτητος έλεγχος" },
          ],
        },
        {
          name: "ΒΕΛΤΙΣΤΟΠΟΙΗΜΕΝΗ ΓΙΑ ΤΑΧΥΤΗΤΑ",
          stages: [
            { num: "1", model: "gemini-2.5-flash", reason: "Γρήγορη αρχική απάντηση" },
            { num: "2", model: "claude-haiku-4-5", reason: "Γρήγορος διασταυρούμενος έλεγχος" },
            { num: "3", model: "grok-3-fast", reason: "Ταχεία σύνθεση" },
          ],
        },
        {
          name: "ΜΕΓΙΣΤΗ ΑΚΡΙΒΕΙΑ",
          stages: [
            { num: "1", model: "claude-opus-4-5", reason: "Ενδελεχής αρχική ανάλυση" },
            { num: "2", model: "gemini-2.5-pro", reason: "Βαθιά επαλήθευση" },
            { num: "3", model: "grok-3", reason: "Ολοκληρωμένος διασταυρούμενος έλεγχος" },
            { num: "4", model: "claude-sonnet-4-5", reason: "Τελική σύνθεση" },
          ],
        },
      ],
    },
    ...
    stageRoles: {
      ...
      stages: [
        { stage: "Στάδιο 1 (Αρχικό)", role: "Δημιουργία αρχικής απάντησης", recommended: "claude-sonnet-4-5, gemini-2.5-flash" },
        { stage: "Στάδιο 2 (Επαλήθευση)", role: "Διασταυρούμενος έλεγχος, επισήμανση σφαλμάτων", recommended: "gemini-2.5-flash, grok-3" },
        { stage: "Στάδιο 3 (Ανάλυση)", role: "Βαθιά ανάλυση, εύρεση αποκλίσεων", recommended: "claude-opus-4-5, gemini-2.5-pro" },
        { stage: "Στάδιο 4 (Σύνθεση)", role: "Απόσταξη τελικής επαληθευμένης απάντησης", recommended: "grok-3, claude-sonnet-4-5" },
      ],
    },
